          ...
          <div class="col-lg-6 mb-5 mb-lg-0">
            <a href="#" class="banner-1 h-100 d-flex" style="background-image: url('images/bg_1.jpg');">
              <div class="banner-1-inner align-self-center">
                <h2>APOTEK LIFE CARE</h2>
                <p>Kami menyediakan segala obat yang Anda butuhkan secara gratis bagi yang memiliki kartu anggota.
                </p>
              </div>
            </a>
          </div>
          <div class="col-lg-6 mb-5 mb-lg-0">
            <a href="#" class="banner-1 h-100 d-flex" style="background-image: url('images/bg_2.jpg');">
              <div class="banner-1-inner ml-auto  align-self-center">
                <h2>RESEP DOKTER</h2>
                <p>Kami menyediakan obat - obat yang di ajukan oleh dokter sesuai dengan yang tertera pada resep dokter.
                </p>
              </div>
            </a>
          </div>
