...
$keterangan = "keluar";
$select = $db->prepare('SELECT * FROM obat WHERE keterangan = :keterangan');
$select->bindParam(":keterangan", $keterangan);
$select->execute();
...
'<head>'.
  ...
  '</style>'.
      ...
      '<tr>'.
        '<td align="center">'.
          '<span style="line-height: 1.6; font-weight: bold;">'.
            '<h1><b>KLINIK UNIVERISTAS LAMBUNG MANGKURAT</b></h1>'.
            '<br>'.
            '<h2><b>KLINIK LIFE CARE ULM </b></h2>'.
            '<br>'.
            '<h4>Jl. Brigjen H. Hasan Basri, Pangeran,Kec. Banjarmasin Utara, Kota Banjarmasin, Kalimantan Selatan</h4>'.
            '<br>'.
            '<h5><b>70123</b></h5>'.
          '</span>'.
        '</td>'.
    ...
    '<hr class="line-title">'. 
    '<p align="center">'.
      '<b>LAPORAN DATA OBAT KELUAR<b>'. '<br>
      <b>2020</b>'.
    '</p>'.
    '<br>'.
