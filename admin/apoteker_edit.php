...
if(isset($_POST['submit'])){
      ...
      $pdo_statement1 = $pdo_conn->prepare("update apoteker set nama_apoteker='" . $_POST[ 'nama' ]. "', no_hp_apoteker=" . $_POST[ 'hp' ]. ", alamat_apoteker='" . $_POST[ 'alamat' ]. "' where username='" . $result4[0]['username']."'");
