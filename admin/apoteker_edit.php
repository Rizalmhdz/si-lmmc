<?php 
    $stmt3 = $pdo_conn->prepare("SELECT * FROM apoteker where id_apoteker=". $_GET["id"]);
    $stmt3->execute();
    $result3 = $stmt3->fetchAll();
    $stmt4 = $pdo_conn->prepare("SELECT * FROM user where username='". $result3[0]['username_apoteker']."'");
    $stmt4->execute();
...
if(isset($_POST['submit'])){
      ...
      $pdo_statement1 = $pdo_conn->prepare("update apoteker set nama_apoteker='" . $_POST[ 'nama' ]. "', no_hp_apoteker=" . $_POST[ 'hp' ]. ", alamat_apoteker='" . $_POST[ 'alamat' ]. "' where username_apoteker='" . $result4[0]['username']."'");
              ...
              <form role="form" id="templatemo-preferences-form" method="post">
                <div class="row">
                  <div class="col-md-6 margin-bottom-15">
                    ...
                    <input type="text" class="form-control" name="nama" required value="<?php echo $result3[0]['nama_apoteker'];?>">                  
                  </div>
                  <div class="col-md-6 margin-bottom-15">
                    <label for="hp" class="control-label">No HP</label>
                    <input type="text" class="form-control" name="hp" required value="<?php echo $result3[0]['no_hp_apoteker'];?>">                  
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12 margin-bottom-15">
                    <label for="alamat" class="control-label">Alamat</label>
                    <input type="text" class="form-control" name="alamat" required value="<?php echo $result3[0]['alamat_apoteker'];?>">                  
                  </div>
                </div>
                <div class="row">
                      <div class="col-md-12 margin-bottom-15">
